...
export const AnimatedStarCenter = () => (
	<AnimatedStar translate="group-hover:-translate-y-7 xl:group-hover:-translate-y-12" />
);

export const AnimatedStarLeft = () => (
	<AnimatedStar translate="group-hover:-translate-y-4 xl:group-hover:-translate-y-7 group-hover:-rotate-90" />
);
