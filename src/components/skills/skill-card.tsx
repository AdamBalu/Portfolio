...
export const SkillCard = ({
	...
	<div className="group relative">
		<div className="h-48 xl:h-64 group-hover:transition-height group-hover:ease-in-out group-hover:duration-500">
			<div className="relative mb-5 mt-4 rounded-2xl h-26 group-hover:h-48 xl:group-hover:h-60 group-hover:transition-height group-hover:duration-700 dark:shadow-[0_15px_5px_5px_#192C65]">
